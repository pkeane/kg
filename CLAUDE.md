...
Write in a sober, rhetorically flat register. Entries should read as encyclopedic reference text, not as essays or magazine profiles. Wikipedia is a closer model than a book review.

Avoid:
- rhetorical opening sentences ("The defining question is...", "What unites these figures is...", "The central problem is...")
- evaluative flourishes ("the most...", "the sharpest...", "the strongest...", "devastating", "brilliant", "indispensable", "canonical")
- synthesizing or narrative moves ("What unites... what divides...", "X's gift was...", "The thread tying...")
- editorial scope sections ("Why these traditions and not others")
- hagiography and dismissiveness alike

Prefer plain attribution: "X argues that…", "Y proposes…", "this volume documents…". Locate the figure or topic in its tradition, name the central books and ideas, summarize the arguments. Assume an intelligent general reader; the entry does not need a "voice" to be readable. The standard Peter has set: entries should read like text generated by a statistical inference engine, not like a clever human essayist.

Earlier entries written before this guidance may still carry an essayistic register; they will be revised toward this standard over time. The "What would [Name] say?" sections are an explicit exception of genre (applied/speculative rather than encyclopedic) and are framed with the italic disclaimer; the rhetorical flatness still applies inside them.
