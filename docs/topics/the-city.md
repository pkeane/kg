...
- **[[forrester-jay|Jay Forrester]]**, *Urban Dynamics* (1969) — the modeling answer to Jacobs, published eight years after *Death and Life*. A hypothetical city simulated as interacting stocks of housing, business, and population; the conclusions were that job training and low-cost housing produce no lasting improvement and that demolition of low-income housing does. The mechanism is in-migration: improvements in conditions raise the city's attractiveness, drawing residents until the model's measures of health — jobs per resident, tax base per capita, upward mobility — return to their prior equilibrium. Demolition improves those measures because the model's boundary is the city line, so residents displaced out of the city leave the simulation and nothing tracks what becomes of them. Gray, Pessel, and Varaiya's "A Critique of Forrester's Model of an Urban Area" (*IEEE Transactions on Systems, Man, and Cybernetics*, 1972) is the technical rebuttal on exactly this point: no commuting across the boundary, no representation of the city's effect on the wider society, and therefore a structure that can only recommend local optimization; the policy conclusions do not survive substitution of real-city data. Read alongside Jacobs's claim that a city is "a problem of organized complexity" — both accept that the city is a system and disagree about whether such a system can be modeled from above — and against the urban-renewal demolitions already underway when the book appeared, six years after James Baldwin's "urban renewal is Negro removal" in his 1963 conversation with Kenneth Clark. Kevin T. Baker's "Model Metropolis" (*Logic* 6, 2018) traces the book's use by Daniel Patrick Moynihan in the Nixon White House and its afterlife as the model underneath *SimCity*.
