...
- *Satisficing* — searching until "good enough," not optimizing
- The firm and the state as hierarchical, not contractual, coordination devices
- The *physical symbol system hypothesis* — the founding thesis of classical AI
- *The sciences of the artificial* — a general science of human-made systems
...
- *Models of Bounded Rationality* (3 vols., 1982, 1997)
- *Reason in Human Affairs* (1983)
- *Models of My Life* (memoir, 1991)

## Secondary sources

- Hunter Crowther-Heyck, *Herbert A. Simon: The Bounds of Reason in Modern America* (2005)
- Mie Augier and James G. March, eds., *Models of a Man: Essays in Memory of Herbert A. Simon* (2004)
