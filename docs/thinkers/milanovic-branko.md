...
related: [piketty-thomas, stiglitz-joseph, reich-robert, hacker-jacob, pierson-paul, inequality, raworth-kate]
influenced_by: []
influenced: []
---
...
His major books extend the argument. *Global Inequality* (2016) is the canonical statement: a history and framework for thinking about inequality at the global rather than national scale. *Capitalism, Alone* (2019) offers a typology for the world after 1989: "liberal meritocratic capitalism" (the West) and "political capitalism" (China and its imitators) as two rival species of capitalism, both internally unequal, neither with a serious challenger. *Visions of Inequality: From the French Revolution to the End of the Cold War* (2023) — his most recent — reads six economists (Quesnay, [[smith-adam|Smith]], Ricardo, [[marx-karl|Marx]], Pareto, Kuznets) as theorists of income distribution. It pairs naturally with [[williams-david-lay|Williams]]'s *The Greatest of All Plagues* and [[mcmahon-darrin|McMahon]]'s *Equality*: three recent books triangulating the history of inequality thought from, respectively, political theory, intellectual history, and economics.

## Key ideas

- Global rather than national inequality as the right unit of analysis
- The elephant curve — who won and lost from 1988–2008 globalization
- Liberal meritocratic capitalism vs. political capitalism
- Kuznets waves (cyclical rather than one-way inequality dynamics)
- The history of economics read as a history of distribution theory
